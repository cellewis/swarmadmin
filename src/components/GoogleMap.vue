...
export default {
  ...
  setup(props, { emit }) {
    let map, heatmap;
    const apiKey = inject("AIzaSyASLVfnb3L5SNpgl1n-Zex0q8_gS5IuDfQ");
    console.log(apiKey);
    function addScripts() {
      ...
      googleMapScript.setAttribute(
        "src",
        `https://maps.googleapis.com/maps/api/js?key=AIzaSyASLVfnb3L5SNpgl1n-Zex0q8_gS5IuDfQ&libraries=visualization`
      );
